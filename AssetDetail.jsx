...
import { formatCurrency, formatDate, formatDateTime, STATUS_LABELS, CONDITION_LABELS, MOVEMENT_LABELS, MAINTENANCE_LABELS, MAINTENANCE_STYLES, DISPOSED_REASON_LABELS, DOC_TYPE_LABELS } from '@/lib/format';
import { canEditAsset, canDisposeAsset, canMoveAsset, canMaintainAsset, canViewFinancials } from '@/lib/permissions';
import { Pencil, ArrowLeftRight, Wrench, Archive, Printer, ImageIcon, FileText, Plus, Trash2, Download } from 'lucide-react';
